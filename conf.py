...
# built documents.
#
version = release = vcversioner.find_version(root=THIS_DIR).version
...
intersphinx_mapping = {
    "characteristic": ("https://characteristic.readthedocs.org/en/latest/", None),
...
man_pages = [
    (master_doc, "themagneticplatformguild", project, [author], 1),
]
